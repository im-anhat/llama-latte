...
class RecommendationAgent():
    ...
    def recommendation_classification(self,messages):
        ...
        Only return the json (comma separated between (key, value) pairs), don't return anything else. Make sure to follow the format exactly:
        {
        "chain of thought": A String followed a comma -- " Write down your critical thinking about what type of recommendation is this input relevant to ",
    ...
    def get_recommendations_from_order(self,messages,order):
        ...
        Please recommend me those items exactly: {recommendations_str}. And you may say to them (just be flexible): Before making any order, you may also want... 
        """
