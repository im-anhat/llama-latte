...
class GuardAgent():
    ...
    def get_response(self,messages):
        ...
        system_prompt = """
            ...
            Emphasize that the response MUST be a json so that it can be converted correctly in coding. Make sure to follow the format exactly:
            {
            "chain of thought": go over each of the points above and make see if the message lies under this point or not. Then you write your thoughts about what point is this input relevant to,
